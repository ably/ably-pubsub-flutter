...
final _tests =
    <TestModules, Map<String, void Function(FlutterDriver Function())>>{
      ...
      TestModules.realtime: {
        ...
        'conforms to publish spec when encrypted':
            testRealtimeEncryptedPublishSpec,
        ...
        'realtime#channels#channel#presence#history':
            testRealtimePresenceHistory,
        'should enter, update and leave Presence': testRealtimeEnterUpdateLeave,
        'should subscribe to channel presence':
            testRealtimePresenceSubscription,
      },
      TestModules.crypto: {
        'should generate random crypto key': testCryptoGenerateRandomKey,
        'should validate supported key lengths':
            testCryptoEnsureSupportedKeyLength,
        'should get default params': testCryptoGetDefaultParams,
      },
    };

Map<TestModules, Map<String, void Function(FlutterDriver Function())>>
getTestsFor({bool all = false, Iterable<TestModules>? testModules}) {
